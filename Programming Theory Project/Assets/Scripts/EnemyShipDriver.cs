...
public class EnemyShipDriver : MonoBehaviour
{
    #region Fields
    private float speed;
    ...
    private float brakeSpeed = 3f;
    private float reverseSpeed = 1f;
    private float idleSlowdown = 3f;

    private float turnSpeed;
    private float turnSpeedMax = 25f;
    private float turnSpeedAcceleration = 5f;
    private float turnIdleSlowdown = 400f;
